const i18n = {
    ko: {
        ...
        set_title: "System Settings", set_lang: "언어 (Language)", set_theme: "테마 설정", set_push: "푸시 알림 수신", set_gps: "앱 실행 시 현위치 탐색", set_sync: "피트니스 동기화 (Health Connect)", set_logout: "로그아웃", set_premium_expiry: "프리미엄 사용기간", set_premium_manage_label: "프리미엄 구독", set_premium_manage_btn: "플레이스토어 구독 관리",
    ...
    ja: {
        ...
        set_title: "システム設定", set_lang: "言語 (Language)", set_theme: "テーマ設定", set_push: "プッシュ通知受信", set_gps: "起動時の位置情報取得", set_sync: "フィットネス同期 (Health Connect)", set_logout: "ログアウト", set_premium_expiry: "プレミアム有効期限", set_premium_manage_label: "プレミアムサブスク", set_premium_manage_btn: "Play Storeで管理",
