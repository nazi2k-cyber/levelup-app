const i18n = {
    ko: {
        ...
        step_req_2: "내 정보 → 구글 피트니스 앱 동기화 활성화",
        ...
        no_friend: "팔로잉한 사용자가 없습니다.", no_follower: "팔로워가 없습니다.", prof_followers: "팔로워", prof_following: "팔로잉", btn_add: "팔로우", btn_added: "팔로잉", gps_on: "위치 권한 활성화됨", gps_off: "위치 탐색 중지됨", gps_err: "위치 정보 오류", gps_denied: "위치 권한이 거부되었습니다. 설정에서 권한을 허용해주세요.", gps_denied_confirm: "위치 권한이 거부된 상태입니다.\n앱 설정에서 위치 권한을 허용하시겠습니까?", gps_unavailable: "위치 정보를 사용할 수 없습니다. GPS 신호를 확인해주세요.", gps_timeout: "위치 탐색 시간이 초과되었습니다. 다시 시도해주세요.", gps_no_support: "위치 서비스를 지원하지 않는 기기입니다.", gps_searching: "위치 탐색 중...", gps_retrying: "위치 재탐색 중...", modal_title: "칭호 이력 조회",
        name_prompt: "새로운 닉네임을 입력하세요.", sync_req: "동기화 요청 중...", sync_done: "동기화 완료 (포인트 지급)", sync_off: "동기화 해제됨",
    ...
    en: {
        ...
        step_req_2: "My Info → Enable Google Fitness App Sync",
        step_req_3: "Sign in to Google & allow activity permission",
        ...
        no_friend: "Not following anyone.", no_follower: "No followers.", prof_followers: "Followers", prof_following: "Following", btn_add: "Follow", btn_added: "Following", gps_on: "Location tracking on", gps_off: "Location tracking off", gps_err: "Location Error", gps_denied: "Location permission denied. Please enable it in settings.", gps_denied_confirm: "Location permission is denied.\nWould you like to open app settings to allow it?", gps_unavailable: "Location unavailable. Please check GPS signal.", gps_timeout: "Location search timed out. Please try again.", gps_no_support: "This device does not support location services.", gps_searching: "Searching location...", gps_retrying: "Retrying location...", modal_title: "Title History",
        name_prompt: "Enter new player name.", sync_req: "Requesting sync...", sync_done: "Sync complete", sync_off: "Sync disabled",
        ...
        settings_guide_fitness_desc: "Your steps sync automatically — earn +10P & STR +0.5 per 1,000 steps daily. Level up while you walk!<br><br>⚠️ <b>For email login users</b><br>Google Fit requires a Google account signed in on your device. On Android 14+ (with Health Connect), it works without a Google account.",
    ...
    ja: {
        ...
        step_req_2: "マイ情報 → Google フィットネスアプリ同期を有効化",
        step_req_3: "Googleアカウントのログインと活動権限の許可",
        ...
        no_friend: "フォロー中のユーザーがいません。", no_follower: "フォロワーがいません。", prof_followers: "フォロワー", prof_following: "フォロー中", btn_add: "フォロー", btn_added: "フォロー中", gps_on: "位置情報有効", gps_off: "位置情報停止", gps_err: "位置情報エラー", gps_denied: "位置情報の権限が拒否されました。設定で許可してください。", gps_denied_confirm: "位置情報の権限が拒否されています。\nアプリ設定で位置情報を許可しますか？", gps_unavailable: "位置情報が利用できません。GPS信号を確認してください。", gps_timeout: "位置情報の取得がタイムアウトしました。再試行してください。", gps_no_support: "この端末は位置情報サービスに対応していません。", gps_searching: "位置情報を検索中...", gps_retrying: "位置情報を再検索中...", modal_title: "称号履歴",
        name_prompt: "新しいプレイヤー名を入力してください。", sync_req: "同期を要求中...", sync_done: "同期完了", sync_off: "同期解除",
        ...
        settings_guide_fitness_desc: "歩数が自動同期され、1,000歩ごとに+10P & STR +0.5の報酬を毎日獲得できます。歩きながらレベルアップ！<br><br>⚠️ <b>メールログインユーザーへのご案内</b><br>Google Fit連携にはデバイスにGoogleアカウントのログインが必要です。Android 14以上（Health Connect対応）ではGoogleアカウントなしでも利用可能です。",
