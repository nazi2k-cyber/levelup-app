const i18n = {
    ko: {
        ...
        step_title: "오늘의 걸음수", step_next_reward: "다음 보상까지 {n}보 남음",
        ad_reward_title: "광고 보고 포인트 받기", ad_reward_btn: "+100P 받기", ad_reward_remaining: "오늘 {n}회 남음", ad_reward_limit: "오늘 횟수를 모두 사용했습니다", ad_reward_confirm: "광고를 시청하고 100P를 받으시겠습니까?", ad_reward_success: "보상이 지급되었습니다! +{n}P", ad_reward_error: "광고를 불러올 수 없습니다. 잠시 후 다시 시도해주세요.", ad_reward_loading: "로딩 중...",
    ...
    en: {
        ...
        step_title: "Today's Steps", step_next_reward: "{n} steps to next reward",
        ad_reward_title: "Watch Ad for Points", ad_reward_btn: "+100P Claim", ad_reward_remaining: "{n} remaining today", ad_reward_limit: "Daily limit reached", ad_reward_confirm: "Watch an ad to earn 100P?", ad_reward_success: "Reward claimed! +{n}P", ad_reward_error: "Failed to load ad. Please try again later.", ad_reward_loading: "Loading...",
    ...
    ja: {
        ...
        step_title: "今日の歩数", step_next_reward: "次の報酬まで{n}歩",
        ad_reward_title: "広告を見てポイント獲得", ad_reward_btn: "+100P 受取", ad_reward_remaining: "本日あと{n}回", ad_reward_limit: "本日の回数を使い切りました", ad_reward_confirm: "広告を視聴して100Pを獲得しますか？", ad_reward_success: "報酬を獲得しました！ +{n}P", ad_reward_error: "広告を読み込めません。しばらくしてからもう一度お試しください。", ad_reward_loading: "読み込み中...",
