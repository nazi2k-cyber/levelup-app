const i18n = {
    ko: {
        ...
        soc_global: "🏆 글로벌 랭킹", soc_friend: "👥 내 친구", sort_tot: "종합스코어", sort_str: "근력", sort_int: "지능", sort_cha: "매력", sort_vit: "체력", sort_wlth: "재력", sort_agi: "민첩", sort_steps: "🚶 걸음수",
        ...
        running_title: "러닝 마일리지", running_period: "최근 7일 누적", running_unit_km: "km", running_unit_mi: "mi",
        running_no_data: "러닝 기록이 없습니다", running_today: "오늘",
        running_req_title: "러닝 마일리지 연동 조건",
        running_req_1: "Google Fit 또는 Health Connect 앱에서 러닝/걷기 활동이 기록되어야 합니다",
        running_req_2: "내 정보 → 구글 피트니스 앱 동기화 활성화",
        running_req_3: "Google 계정의 활동 및 거리 데이터 권한 허용 필요",
        running_consent_desc: "러닝 마일리지는 Google Fit의 거리 데이터를 활용합니다. 자세한 내용은 {link}을 참고하세요.",
        running_consent_link_text: "Google Fit 데이터 정책",
        ...
        settings_guide_fitness_desc: "걸음 수가 자동으로 동기화되어 1,000보당 +10P & STR +0.5 보상을 매일 받을 수 있습니다. 걸으면서 레벨업!<br><br><b style='color:var(--neon-gold);'>⚠ Google 미인증 앱 경고가 나타나면?</b><br>하단의 <b>[고급]</b>을 탭한 후 <b>[LevelUp: Reboot(으)로 이동]</b>을 선택하면 안전하게 연동됩니다. 앱은 걸음 수와 이동 거리만 읽으며 다른 데이터에는 접근하지 않습니다.",
        fitness_preauth_title: "Google 피트니스 연동 안내",
        fitness_preauth_desc: "Google Fit 데이터에 접근하기 위해 Google 로그인 화면이 나타납니다.\n\n'Google에서 확인하지 않은 앱' 경고가 표시되면:\n\n1. [고급]을 탭하세요\n2. [LevelUp: Reboot(으)로 이동]을 탭하세요\n3. 이동 거리 / 이동 속도 권한을 [완료]로 허용하세요\n\n앱은 걸음 수와 이동 거리만 읽습니다.",
        fitness_preauth_continue: "계속하기",
        fitness_preauth_cancel: "취소",
    ...
    en: {
        ...
        soc_global: "🏆 Global Rank", soc_friend: "👥 My Friends", sort_tot: "Total", sort_str: "STR", sort_int: "INT", sort_cha: "CHA", sort_vit: "VIT", sort_wlth: "WLTH", sort_agi: "AGI", sort_steps: "🚶 Steps",
        ...
        running_title: "Running Mileage", running_period: "Last 7 days total", running_unit_km: "km", running_unit_mi: "mi",
        running_no_data: "No running records", running_today: "Today",
        running_req_title: "Running Mileage Requirements",
        running_req_1: "Running/walking activity must be recorded in Google Fit or Health Connect",
        running_req_2: "My Info → Enable Google Fitness App Sync",
        running_req_3: "Allow activity & distance data permission for your Google account",
        running_consent_desc: "Running mileage uses distance data from Google Fit. See {link} for details.",
        running_consent_link_text: "Google Fit Data Policy",
        ...
        settings_guide_fitness_desc: "Your steps sync automatically — earn +10P & STR +0.5 per 1,000 steps daily. Level up while you walk!<br><br><b style='color:var(--neon-gold);'>⚠ If you see an 'Unverified app' warning?</b><br>Tap <b>[Advanced]</b> at the bottom, then select <b>[Go to LevelUp: Reboot]</b> to connect safely. The app only reads your step count and distance — no other data is accessed.",
        fitness_preauth_title: "Google Fitness Sync Guide",
        fitness_preauth_desc: "A Google sign-in screen will appear to access Google Fit data.\n\nIf you see an 'App not verified by Google' warning:\n\n1. Tap [Advanced]\n2. Tap [Go to LevelUp: Reboot (unsafe)]\n3. Allow the distance/speed permissions and tap [Done]\n\nThe app only reads your step count and distance.",
        fitness_preauth_continue: "Continue",
        fitness_preauth_cancel: "Cancel",
    ...
    ja: {
        ...
        running_title: "ランニングマイレージ", running_period: "直近7日間の累計", running_unit_km: "km", running_unit_mi: "mi",
        running_no_data: "ランニング記録がありません", running_today: "今日",
        running_req_title: "ランニングマイレージ連動条件",
        running_req_1: "Google Fit または Health Connect アプリでランニング/ウォーキングの記録が必要",
        running_req_2: "マイ情報 → Google フィットネスアプリ同期を有効化",
        running_req_3: "Googleアカウントの活動・距離データ権限の許可が必要",
        running_consent_desc: "ランニングマイレージはGoogle Fitの距離データを使用します。詳細は{link}をご確認ください。",
        running_consent_link_text: "Google Fit データポリシー",
        ...
        settings_guide_fitness_desc: "歩数が自動同期され、1,000歩ごとに+10P & STR +0.5の報酬を毎日獲得できます。歩きながらレベルアップ！<br><br><b style='color:var(--neon-gold);'>⚠ Googleの未確認アプリ警告が表示された場合</b><br>下部の<b>[詳細]</b>をタップし、<b>[LevelUp: Rebootに移動]</b>を選択すると安全に連携できます。アプリは歩数と移動距離のみを読み取り、他のデータにはアクセスしません。",
        fitness_preauth_title: "Googleフィットネス連携ガイド",
        fitness_preauth_desc: "Google Fitデータにアクセスするため、Googleログイン画面が表示されます。\n\n「Googleで確認されていないアプリ」警告が表示された場合：\n\n1. [詳細]をタップしてください\n2. [LevelUp: Rebootに移動（安全ではありません）]をタップしてください\n3. 移動距離/移動速度の権限を[完了]で許可してください\n\nアプリは歩数と移動距離のみを読み取ります。",
        fitness_preauth_continue: "続行",
        fitness_preauth_cancel: "キャンセル",
