const i18n = {
    ko: {
        ...
        set_title: "System Settings", set_lang: "언어 (Language)", set_theme: "색상", set_bg_theme_btn: "🎨 배경테마", bg_theme_modal_title: "배경테마", bg_theme_basic: "기본 (7종)", bg_theme_premium: "프리미엄", bg_theme_name_default: "기본", bg_theme_name_midnight: "미드나잇", bg_theme_name_navy: "네이비", bg_theme_name_slate: "슬레이트", bg_theme_name_charcoal: "차콜", bg_theme_name_forest: "포레스트", bg_theme_name_moss: "모스", bg_theme_name_sand: "샌드", bg_theme_name_wine: "와인", bg_theme_name_violet: "바이올렛", bg_theme_name_carbon: "카본", bg_theme_name_grid_blue: "블루그리드", bg_theme_name_grid_gold: "골드그리드", bg_theme_name_dot_cyan: "시안도트", bg_theme_name_dot_rose: "로즈도트", bg_theme_name_diag_purple: "퍼플대각", bg_theme_name_diag_teal: "틸대각", bg_theme_name_stripe_blue: "블루스트라이프", bg_theme_name_stripe_red: "레드스트라이프", bg_theme_name_honeycomb: "허니콤", bg_theme_name_cross: "크로스", bg_theme_name_waves: "웨이브", bg_theme_name_sunset: "선셋", bg_theme_name_aurora: "오로라", bg_theme_name_nebula: "네뷸라", bg_theme_name_pearl: "펄", bg_theme_name_olive: "올리브", bg_theme_name_cobalt: "코발트", bg_theme_name_stone: "스톤", bg_theme_name_mint: "민트", set_push: "푸시 알림 수신", set_gps: "앱 실행 시 현위치 탐색", set_sync: "피트니스 동기화 (Health Connect)", set_logout: "로그아웃", set_premium_expiry: "프리미엄 사용기간", set_premium_manage_label: "프리미엄 구독", set_premium_manage_btn: "플레이스토어 구독 관리",
        ...
        diary_save: "저장", diary_saved: "플래너가 저장되었습니다.", diary_saved_reward: "플래너가 저장되었습니다.\n🎁 저장 보상: +20P & AGI +0.5", diary_written: "작성 완료 ✓",
        diary_tab_title: "🗓️ 플래너",
        planner_tab_priority: "⭐ 우선순위 태스크", planner_tab_schedule: "🕐 시간표",
        profile_planner_btn: "플래너", profile_view_planner: "당일 플래너", profile_no_today_plan: "당일 플랜이 없습니다.", profile_share_btn: "공유", profile_share_copied: "프로필 링크가 클립보드에 복사되었습니다.", profile_share_failed: "공유에 실패했습니다. 다시 시도해주세요.", profile_save_btn: "저장",
        ...
        btn_excel_export: "📊 내보내기",
        btn_excel_import: "📥 가져오기",
        btn_gcal_sync: "📅 구글 연동",
        gcal_no_blocks: "동기화할 시간표가 없습니다. 먼저 시간표를 작성해주세요.",
        gcal_syncing: "Google Calendar 동기화 중...",
        gcal_done: "Google Calendar에 {count}개 일정이 추가되었습니다!",
        gcal_denied: "Google Calendar 권한이 거부되었습니다.",
        gcal_error: "Google Calendar 동기화에 실패했습니다: {msg}",
        gcal_scope_required: "Google Calendar 접근 권한이 필요합니다.",
        excel_no_data: "내보낼 플래너 데이터가 없습니다.",
        excel_import_done: "플래너 데이터를 가져왔습니다. ({count}일)",
        excel_import_error: "CSV 파일을 읽을 수 없습니다. 형식을 확인하세요.",
        excel_import_empty: "유효한 데이터가 없습니다.",
        excel_export_error: "내보내기 오류가 발생했습니다. 다시 시도하세요.",
        excel_import_modal_title: "📥 플래너 데이터 가져오기",
        excel_template_hint: "먼저 템플릿 파일을 다운로드하고 데이터를 입력하세요.",
        excel_template_download: "📄 템플릿 다운로드",
        excel_upload_hint: "작성 완료된 파일을 업로드하세요.",
        excel_select_file: "📎 파일 선택 (클릭)",
        excel_upload_btn: "업로드",
        btn_day1_info: "가이드",
        ...
        day1_guide_report_policy: "⚠️ 커뮤니티 규정 위반 게시물은 신고 후 관리자가 삭제합니다. 게시물 삭제 4회 누적 시 계정이 7일간 자동 정지되며, 4회 정지 시 계정이 영구 삭제됩니다.",
        btn_social_info: "가이드",
        social_guide_title: "소셜 가이드",
        social_guide_ranking_desc: "소셜 탭에서 다른 플레이어와 스탯을 비교하고 글로벌 순위를 확인할 수 있습니다. 팔로잉·팔로워 순위도 지원합니다.",
        social_guide_report_policy: "⚠️ 커뮤니티 규정: 신고 누적 게시물은 관리자가 검토 후 삭제할 수 있습니다. 게시물 삭제 4회 누적 시 계정이 7일간 자동 정지되며, 4회 정지 시 계정이 영구 삭제됩니다.",
        ...
        weekday_sun: "일", weekday_mon: "월", weekday_tue: "화", weekday_wed: "수", weekday_thu: "목", weekday_fri: "금", weekday_sat: "토",
        ...
        // 권한 안내 페이지
        pg_feature_label: "이런 기능에 사용돼요",
        pg_allow_btn: "허용하기", pg_skip_btn: "나중에",
        pg_title_push: "알림 권한 안내", pg_desc_push: "퀘스트 알림과 레이드 참여 알림을<br>실시간으로 받아볼 수 있어요", pg_ficon_push: "📋", pg_fname_push: "퀘스트", pg_fdesc_push: "미션 완료 시 즉시 알림 받기",
        pg_title_health: "신체 활동 권한 안내", pg_desc_health: "오늘의 걸음수를 자동으로 기록하고<br>퀘스트 보상도 함께 받아보세요", pg_ficon_health: "👟", pg_fname_health: "내 걸음", pg_fdesc_health: "걸음수 자동 추적 및 보상 지급",
        pg_title_gps: "위치 권한 안내", pg_desc_gps: "현재 위치 기반으로 던전을 탐험하고<br>레이드 보상을 획득해보세요", pg_ficon_gps: "🏰", pg_fname_gps: "던전", pg_fdesc_gps: "내 위치 기반 던전 탐험",
        ...
        med_quick_guide_mindfulness: "<span style=\"color:#00e5a0; font-weight:700;\">[마음챙김]</span> 지금 이 순간의 현존 · 호흡 감각에 주의를 두고, 잡념은 판단 없이 알아차린 뒤 다시 호흡으로 돌아옵니다. (5~10분)",
        ...
        fb_err_user_disabled: "계정이 정지되었습니다. 신고 누적으로 인한 자동 정지의 경우 7일 후 자동 해제됩니다. 문의사항은 고객센터를 이용해 주세요.",
        ...
        habit_project_title: "습관형성 프로젝트",
        habit_name_label: "원하는 습관명",
        habit_name_placeholder: "예: 물 2L 마시기",
        habit_difficulty_label: "난이도",
        habit_difficulty_easy: "쉬움",
        habit_difficulty_medium: "보통",
        habit_difficulty_hard: "어려움",
        habit_settings_title: "습관형성 프로젝트 설정",
        habit_guide_btn: "가이드",
        habit_day_title: "{day}일차",
        habit_stage1_title: "저항 단계",
        habit_stage2_title: "과도기 단계",
        habit_stage3_title: "자동화 단계",
        habit_phase_caption: "저항 단계({r_start}~{r_end}일) > 과도기 단계({t_start}~{t_end}일) > 자동화 단계({a_start}~{a_end}일)",
        habit_start_date: "시작일: {date}", habit_target_date: "달성일: {date}",
        habit_elapsed_days: "경과일: {days}일",
        habit_completion_rate: "달성률: {rate}%",
        habit_name_required: "습관명을 입력해주세요.",
        habit_no_name_check_error: "습관명을 먼저 설정해주세요.",
        habit_future_check_error: "미래 날짜는 체크할 수 없습니다.",
        habit_completion_rate_none: "달성률: -",
        habit_stage_bonus_msg: "🎉 {stage} 완료! 보너스 AGI +{bonus}",
        ...
        fnw_consent_label: "미래 순자산 정보를 서버에 저장하고 소셜탭 저축왕 순위에 공개하는 것에 동의합니다.\n[수집 항목] 목표 기간, 연소득, 명목 임금상승률, 현재 자산/부채, 물가상승률, 지출 비율, 목돈 지출 계획, 월 가용 저축액 / [수집 목적] 저축왕 순위 제공 / [보관] 계정 삭제 또는 초기화 시까지",
        ...
        fnw_inflate_lump: "목돈 지출에 목표 기간 후 미래 물가 자동 반영",
        fnw_inflate_total: "물가반영 총액",
        fnw_btn_detail: "📊 계산 상세",
        fnw_detail_title: "📊 계산 상세내역",
        fnw_detail_params: "계산 파라미터",
        fnw_detail_a0: "현재 순자산 (A₀)",
        fnw_detail_wtotal: "누적 수입 (W_total)",
        fnw_detail_efixed: "고정 지출 (E_fixed)",
        fnw_detail_snon: "비정기 지출 (S_non)",
        fnw_detail_nwn: "예상 순자산 (NW_n)",
        fnw_detail_nwn_pv: "현재 가치 환산 순자산 (PV)",
        fnw_detail_msave: "월 필요 저축액 (M_save)",
        fnw_detail_mavail: "월 가용 저축액 (M_avail)",
        fnw_detail_no_config: "먼저 설정을 완료해주세요.",
        fnw_detail_inflate_badge: "(물가반영)",
        fnw_detail_original: "현재가격",
        fnw_detail_inflated: "미래가격",
    ...
    en: {
        ...
        set_title: "System Settings", set_lang: "Language", set_theme: "Color", set_bg_theme_btn: "🎨 Background Theme", bg_theme_modal_title: "Background Theme", bg_theme_basic: "Basic (7)", bg_theme_premium: "Premium", bg_theme_name_default: "Default", bg_theme_name_midnight: "Midnight", bg_theme_name_navy: "Navy", bg_theme_name_slate: "Slate", bg_theme_name_charcoal: "Charcoal", bg_theme_name_forest: "Forest", bg_theme_name_moss: "Moss", bg_theme_name_sand: "Sand", bg_theme_name_wine: "Wine", bg_theme_name_violet: "Violet", bg_theme_name_carbon: "Carbon", bg_theme_name_grid_blue: "Blue Grid", bg_theme_name_grid_gold: "Gold Grid", bg_theme_name_dot_cyan: "Cyan Dot", bg_theme_name_dot_rose: "Rose Dot", bg_theme_name_diag_purple: "Purple Diagonal", bg_theme_name_diag_teal: "Teal Diagonal", bg_theme_name_stripe_blue: "Blue Stripe", bg_theme_name_stripe_red: "Red Stripe", bg_theme_name_honeycomb: "Honeycomb", bg_theme_name_cross: "Cross", bg_theme_name_waves: "Waves", bg_theme_name_sunset: "Sunset", bg_theme_name_aurora: "Aurora", bg_theme_name_nebula: "Nebula", bg_theme_name_pearl: "Pearl", bg_theme_name_olive: "Olive", bg_theme_name_cobalt: "Cobalt", bg_theme_name_stone: "Stone", bg_theme_name_mint: "Mint", set_push: "Push Notifications", set_gps: "Auto Location Tracking", set_sync: "Fitness Sync (Health Connect)", set_logout: "Logout", set_premium_expiry: "Premium Expiry", set_premium_manage_label: "Premium Subscription", set_premium_manage_btn: "Manage on Play Store",
        ...
        diary_save: "Save", diary_saved: "Planner saved.", diary_saved_reward: "Planner saved.\n🎁 Save reward: +20P & AGI +0.5", diary_written: "Written ✓",
        diary_tab_title: "🗓️ Planner",
        planner_tab_priority: "⭐ Priority Tasks", planner_tab_schedule: "🕐 Schedule",
        profile_planner_btn: "Planner", profile_view_planner: "Today's Planner", profile_no_today_plan: "No plan for today.", profile_share_btn: "Share", profile_share_copied: "Profile link copied to clipboard.", profile_share_failed: "Failed to share profile. Please try again.", profile_save_btn: "Save",
        ...
        btn_excel_export: "📊 Export",
        btn_excel_import: "📥 Import",
        btn_gcal_sync: "📅 Google Sync",
        gcal_no_blocks: "No schedule to sync. Add schedule first.",
        gcal_syncing: "Syncing to Google Calendar...",
        gcal_done: "{count} event(s) added to Google Calendar!",
        gcal_denied: "Google Calendar permission was denied.",
        gcal_error: "Google Calendar sync failed: {msg}",
        gcal_scope_required: "Google Calendar access permission required.",
        excel_no_data: "No planner data to export.",
        excel_import_done: "Planner data imported. ({count} days)",
        excel_import_error: "Could not read the CSV file. Check the format.",
        excel_import_empty: "No valid data found.",
        excel_export_error: "Export failed. Please try again.",
        excel_import_modal_title: "📥 Import Planner Data",
        excel_template_hint: "Download the template first and fill in your data.",
        excel_template_download: "📄 Download Template",
        excel_upload_hint: "Then upload the completed file below.",
        excel_select_file: "📎 Select File (click)",
        ...
        day1_guide_report_policy: "⚠️ Posts that violate community guidelines may be removed by admins. Accumulating 4 post deletions results in a 7-day account suspension; 4 suspensions lead to permanent account deletion.",
        btn_social_info: "Guide",
        social_guide_title: "Social Guide",
        social_guide_ranking_desc: "Compare your stats with other players and check global rankings in the Social tab. Friends and followers rankings are also supported.",
        social_guide_report_policy: "⚠️ Community Rules: Posts with accumulated reports may be reviewed and removed by admins. 4 post deletions result in a 7-day suspension; 4 suspensions lead to permanent account deletion.",
        ...
        // Permission guide pages
        pg_feature_label: "Used for these features",
        pg_allow_btn: "Allow", pg_skip_btn: "Later",
        pg_title_push: "Notification Permission", pg_desc_push: "Get real-time alerts for quests<br>and raid invitations", pg_ficon_push: "📋", pg_fname_push: "Quests", pg_fdesc_push: "Get notified when missions complete",
        pg_title_health: "Physical Activity Permission", pg_desc_health: "Automatically track your daily steps<br>and earn quest rewards", pg_ficon_health: "👟", pg_fname_health: "My Steps", pg_fdesc_health: "Auto-track steps & earn rewards",
        pg_title_gps: "Location Permission", pg_desc_gps: "Explore dungeons based on your location<br>and claim raid rewards", pg_ficon_gps: "🏰", pg_fname_gps: "Dungeon", pg_fdesc_gps: "Location-based dungeon exploration",
        ...
        med_quick_guide_mindfulness: "<span style=\"color:#00e5a0; font-weight:700;\">[Mindfulness]</span> Focus on present-moment awareness and the sensation of breath; when thoughts arise, notice them without judgment and gently return to breathing. (5-10 min)",
        ...
        fb_err_user_disabled: "Your account has been suspended. If this is an automatic suspension due to accumulated reports, it will be lifted after 7 days. Please contact support if you need assistance.",
        ...
        habit_project_title: "Habit Project",
        habit_name_label: "Habit Name",
        habit_name_placeholder: "e.g., Drink 2L of water",
        habit_difficulty_label: "Difficulty",
        habit_difficulty_easy: "Easy",
        habit_difficulty_medium: "Medium",
        habit_difficulty_hard: "Hard",
        habit_settings_title: "Habit Project Settings",
        habit_guide_btn: "Guide",
        habit_day_title: "Day {day}",
        habit_stage1_title: "Resistance Stage",
        habit_stage2_title: "Transition Stage",
        habit_stage3_title: "Automation Stage",
        habit_phase_caption: "Resistance (Day 1–22) > Transition (Day 23–44) > Automation (Day 45–66)",
        habit_start_date: "Start Date: {date}", habit_target_date: "Target Date: {date}",
        habit_elapsed_days: "Elapsed: {days} days",
        habit_completion_rate: "Completion: {rate}%",
        habit_name_required: "Please enter a habit name.",
        habit_no_name_check_error: "Please set a habit name first.",
        habit_future_check_error: "You cannot check future dates.",
        habit_completion_rate_none: "Rate: -",
        habit_stage_bonus_msg: "🎉 {stage} complete! Bonus AGI +{bonus}",
        ...
        fnw_label_nw_pv: "Est. Net Worth (Present Value)",
        fnw_label_m_save: "Monthly Savings Needed",
        fnw_label_m_avail: "Monthly Available Savings",
        ...
        fnw_section_income: "Income & Return Settings",
        ...
        fnw_label_g: "Nominal Wage Growth (%)",
        fnw_label_roi: "Investment ROI (%)",
        ...
        fnw_consent_label: "I agree to store my future net worth data on the server and publish it in the Savings King ranking on the Social tab.\n[Data collected] Goal period, annual income, nominal wage growth, assets/liabilities, inflation rate, expense ratio, lump-sum plans, monthly available savings / [Purpose] Savings King ranking / [Retention] Until account deletion or data reset",
        ...
        fnw_inflate_lump: "Auto-apply future prices to lump-sum expenses",
        fnw_inflate_total: "Inflation-adjusted total",
        fnw_btn_detail: "📊 Details",
        fnw_detail_title: "📊 Calculation Details",
        fnw_detail_params: "Parameters",
        fnw_detail_a0: "Current Net Worth (A₀)",
        fnw_detail_wtotal: "Cumul. Income (W_total)",
        fnw_detail_efixed: "Fixed Expenses (E_fixed)",
        fnw_detail_snon: "Lump-Sum Expenses (S_non)",
        fnw_detail_nwn: "Est. Net Worth (NW_n)",
        fnw_detail_nwn_pv: "Present Value Net Worth (PV)",
        fnw_detail_msave: "Monthly Savings Needed (M_save)",
        fnw_detail_mavail: "Monthly Available Savings (M_avail)",
        fnw_detail_no_config: "Please complete the settings first.",
        fnw_detail_inflate_badge: "(inflation-adj.)",
        fnw_detail_original: "Current price",
        fnw_detail_inflated: "Future price",
    ...
    ja: {
        ...
        set_title: "システム設定", set_lang: "言語 (Language)", set_theme: "色", set_bg_theme_btn: "🎨 背景テーマ", bg_theme_modal_title: "背景テーマ", bg_theme_basic: "基本 (7種)", bg_theme_premium: "プレミアム", bg_theme_name_default: "基本", bg_theme_name_midnight: "ミッドナイト", bg_theme_name_navy: "ネイビー", bg_theme_name_slate: "スレート", bg_theme_name_charcoal: "チャコール", bg_theme_name_forest: "フォレスト", bg_theme_name_moss: "モス", bg_theme_name_sand: "サンド", bg_theme_name_wine: "ワイン", bg_theme_name_violet: "バイオレット", bg_theme_name_carbon: "カーボン", bg_theme_name_grid_blue: "ブルーグリッド", bg_theme_name_grid_gold: "ゴールドグリッド", bg_theme_name_dot_cyan: "シアンドット", bg_theme_name_dot_rose: "ローズドット", bg_theme_name_diag_purple: "パープル斜線", bg_theme_name_diag_teal: "ティール斜線", bg_theme_name_stripe_blue: "ブルーストライプ", bg_theme_name_stripe_red: "レッドストライプ", bg_theme_name_honeycomb: "ハニカム", bg_theme_name_cross: "クロス", bg_theme_name_waves: "ウェーブ", bg_theme_name_sunset: "サンセット", bg_theme_name_aurora: "オーロラ", bg_theme_name_nebula: "ネビュラ", bg_theme_name_pearl: "パール", bg_theme_name_olive: "オリーブ", bg_theme_name_cobalt: "コバルト", bg_theme_name_stone: "ストーン", bg_theme_name_mint: "ミント", set_push: "プッシュ通知受信", set_gps: "起動時の位置情報取得", set_sync: "フィットネス同期 (Health Connect)", set_logout: "ログアウト", set_premium_expiry: "プレミアム有効期限", set_premium_manage_label: "プレミアムサブスク", set_premium_manage_btn: "Play Storeで管理",
        ...
        diary_save: "保存", diary_saved: "プランナーが保存されました。", diary_saved_reward: "プランナーが保存されました。\n🎁 保存報酬: +20P & AGI +0.5", diary_written: "記録完了 ✓",
        diary_tab_title: "🗓️ プランナー",
        planner_tab_priority: "⭐ 優先タスク", planner_tab_schedule: "🕐 スケジュール",
        profile_planner_btn: "プランナー", profile_view_planner: "本日のプランナー", profile_no_today_plan: "本日のプランはありません。", profile_share_btn: "共有", profile_share_copied: "プロフィールリンクをクリップボードにコピーしました。", profile_share_failed: "共有に失敗しました。もう一度お試しください。", profile_save_btn: "保存",
        ...
        btn_excel_export: "📊 エクスポート",
        btn_excel_import: "📥 インポート",
        btn_gcal_sync: "📅 Google連携",
        gcal_no_blocks: "同期するスケジュールがありません。先に予定を追加してください。",
        gcal_syncing: "Googleカレンダーに同期中...",
        gcal_done: "Googleカレンダーに{count}件の予定が追加されました！",
        gcal_denied: "Googleカレンダーの権限が拒否されました。",
        gcal_error: "Googleカレンダー同期に失敗しました: {msg}",
        gcal_scope_required: "Googleカレンダーのアクセス権限が必要です。",
        excel_no_data: "エクスポートするデータがありません。",
        excel_import_done: "プランナーデータをインポートしました。({count}日)",
        excel_import_error: "CSVファイルを読み込めません。フォーマットを確認してください。",
        excel_import_empty: "有効なデータが見つかりません。",
        excel_export_error: "エクスポートに失敗しました。もう一度お試しください。",
        excel_import_modal_title: "📥 プランナーデータのインポート",
        excel_template_hint: "まずテンプレートファイルをダウンロードしてデータを入力してください。",
        excel_template_download: "📄 テンプレートダウンロード",
        excel_upload_hint: "記入済みのファイルをアップロードしてください。",
        excel_select_file: "📎 ファイル選択（クリック）",
        excel_upload_btn: "アップロード",
        btn_day1_info: "ガイド",
        ...
        day1_guide_report_policy: "⚠️ コミュニティガイドラインに違反した投稿は管理者が削除する場合があります。投稿削除が4回累積するとアカウントが7日間停止され、4回停止でアカウントが永久削除されます。",
        btn_social_info: "ガイド",
        social_guide_title: "ソーシャルガイド",
        social_guide_ranking_desc: "ソーシャルタブで他のプレイヤーとステータスを比較し、グローバルランキングを確認できます。フォロー・フォロワーランキングも対応しています。",
        social_guide_report_policy: "⚠️ コミュニティルール: 報告累積の投稿は管理者が確認・削除する場合があります。投稿削除4回で7日間停止、4回停止でアカウントが永久削除されます。",
        ...
        weekday_sun: "日", weekday_mon: "月", weekday_tue: "火", weekday_wed: "水", weekday_thu: "木", weekday_fri: "金", weekday_sat: "土",
        ...
        // 権限案内ページ
        pg_feature_label: "このような機能に使われます",
        pg_allow_btn: "許可する", pg_skip_btn: "あとで",
        pg_title_push: "通知権限のご案内", pg_desc_push: "クエスト通知やレイド参加通知を<br>リアルタイムで受け取れます", pg_ficon_push: "📋", pg_fname_push: "クエスト", pg_fdesc_push: "ミッション完了時に即通知",
        pg_title_health: "身体活動権限のご案内", pg_desc_health: "今日の歩数を自動で記録して<br>クエスト報酬ももらえます", pg_ficon_health: "👟", pg_fname_health: "マイ歩数", pg_fdesc_health: "歩数自動追跡と報酬付与",
        pg_title_gps: "位置情報権限のご案内", pg_desc_gps: "現在地のダンジョンを探索して<br>レイド報酬をゲットしましょう", pg_ficon_gps: "🏰", pg_fname_gps: "ダンジョン", pg_fdesc_gps: "位置情報でダンジョン探索",
        ...
        med_quick_guide_mindfulness: "<span style=\"color:#00e5a0; font-weight:700;\">[マインドフルネス]</span> 今この瞬間と呼吸感覚に意識を向け、雑念が浮かんだら判断せず気づいて、やさしく呼吸へ戻ります。（5〜10分）",
        ...
        fb_err_user_disabled: "アカウントが停止されています。報告累積による自動停止の場合、7日後に自動解除されます。お問い合わせはサポートまでご連絡ください。",
        ...
        habit_project_title: "習慣形成プロジェクト",
        habit_name_label: "習慣名",
        habit_name_placeholder: "例: 水を2L飲む",
        habit_difficulty_label: "難易度",
        habit_difficulty_easy: "易しい",
        habit_difficulty_medium: "普通",
        habit_difficulty_hard: "難しい",
        habit_settings_title: "習慣形成プロジェクト設定",
        habit_guide_btn: "ガイド",
        habit_day_title: "{day}日目",
        habit_stage1_title: "抵抗段階",
        habit_stage2_title: "過渡期段階",
        habit_stage3_title: "自動化段階",
        habit_phase_caption: "抵抗段階(1〜22日) > 過渡期段階(23〜44日) > 自動化段階(45〜66日)",
        habit_start_date: "開始日: {date}", habit_target_date: "達成日: {date}",
        habit_elapsed_days: "経過日: {days}日",
        habit_completion_rate: "達成率: {rate}%",
        habit_name_required: "習慣名を入力してください。",
        habit_no_name_check_error: "習慣名を先に設定してください。",
        habit_future_check_error: "未来の日付はチェックできません。",
        habit_completion_rate_none: "達成率: -",
        habit_stage_bonus_msg: "🎉 {stage} 完了！ボーナス AGI +{bonus}",
        ...
        fnw_consent_label: "将来の純資産情報をサーバーに保存し、ソーシャルタブの貯蓄王ランキングに公開することに同意します。\n[収集項目] 目標期間・年収・名目賃金上昇率・資産/負債・インフレ率・支出比率・一括支出計画・月利用可能貯蓄額 / [目的] 貯蓄王ランキング提供 / [保管] アカウント削除または初期化まで",
        ...
        fnw_inflate_lump: "一括支出に将来物価を自動反映",
        fnw_inflate_total: "物価反映合計",
        fnw_btn_detail: "📊 詳細",
        fnw_detail_title: "📊 計算詳細",
        fnw_detail_params: "計算パラメータ",
        fnw_detail_a0: "現在純資産 (A₀)",
        fnw_detail_wtotal: "累積収入 (W_total)",
        fnw_detail_efixed: "固定支出 (E_fixed)",
        fnw_detail_snon: "一括支出合計 (S_non)",
        fnw_detail_nwn: "予想純資産 (NW_n)",
        fnw_detail_nwn_pv: "現在価値換算純資産 (PV)",
        fnw_detail_msave: "月必要積立額 (M_save)",
        fnw_detail_mavail: "月利用可能貯蓄額 (M_avail)",
        fnw_detail_no_config: "先に設定を完了してください。",
        fnw_detail_inflate_badge: "(物価反映)",
        fnw_detail_original: "現在価格",
        fnw_detail_inflated: "将来価格",
