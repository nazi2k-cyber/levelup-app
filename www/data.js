const i18n = {
    ko: {
        ...
        name_prompt: "새로운 닉네임을 입력하세요.", exit_hint: "종료하려면 다시 누르세요",
    ...
    en: {
        ...
        name_prompt: "Enter new player name.", exit_hint: "Press back again to exit",
    ...
    ja: {
        ...
        name_prompt: "新しいプレイヤー名を入力してください。", exit_hint: "もう一度押すと終了します",
