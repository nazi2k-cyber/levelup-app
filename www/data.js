const i18n = {
    ko: {
        ...
        fnw_label_nw_real: "예상 순자산(현재 가치 환산)",
        ...
        fnw_label_roi: "연 투자수익률 ROI (%)",
        fnw_roi_help: "평균 예적금 금리(정책 기본값)를 기준으로 설정됩니다.",
        ...
        fnw_consent_label: "미래 순자산 정보를 서버에 저장하고 소셜탭 저축왕 순위에 공개하는 것에 동의합니다.\n[수집 항목] 목표 기간, 연소득, 명목 임금상승률, 현재 자산/부채, 물가상승률, ROI(할인율), 지출 비율, 목돈 지출 계획, 월 가용 저축력 / [수집 목적] 저축왕 순위 제공 / [보관] 계정 삭제 또는 초기화 시까지",
        ...
        fnw_detail_nwn_nominal: "예상 순자산 (명목)",
        fnw_detail_nwn_real: "예상 순자산 (현재 가치 환산)",
        fnw_detail_discount_factor: "할인계수",
        fnw_detail_nwn: "ROI 반영 전 순자산 (NW_n)",
        fnw_detail_roi: "연 투자수익률 (ROI)",
        fnw_detail_nw_real: "ROI 반영 후 순자산 (NW_n_nominal)",
        fnw_detail_msave: "월 필요 저축액 (M_save)",
        fnw_detail_mavail: "월 가용 저축력 (M_avail)",
    ...
    en: {
        ...
        fnw_label_nw_real: "Est. Net Worth (Present Value)",
        ...
        fnw_label_roi: "Annual ROI (%)",
        fnw_roi_help: "Defaults to a policy baseline based on average deposit/savings rates.",
        ...
        fnw_consent_label: "I agree to store my future net worth data on the server and publish it in the Savings King ranking on the Social tab.\n[Data collected] Goal period, annual income, nominal wage growth, assets/liabilities, inflation rate, ROI (discount rate), expense ratio, lump-sum plans, monthly savings capacity / [Purpose] Savings King ranking / [Retention] Until account deletion or data reset",
        ...
        fnw_detail_nwn_nominal: "Est. Net Worth (Nominal)",
        fnw_detail_nwn_real: "Est. Net Worth (Present Value)",
        fnw_detail_discount_factor: "Discount Factor",
        fnw_detail_nwn: "Net Worth before ROI (NW_n)",
        fnw_detail_roi: "Annual ROI",
        fnw_detail_nw_real: "Net Worth after ROI (NW_n_nominal)",
        fnw_detail_msave: "Monthly Savings Needed (M_save)",
        fnw_detail_mavail: "Monthly Savings Capacity (M_avail)",
    ...
    ja: {
        ...
        fnw_label_nw_real: "予想純資産（現在価値換算）",
        ...
        fnw_label_r: "年インフレ率（%）",
        fnw_label_g: "名目賃金上昇率（%）",
        fnw_label_roi: "年間投資収益率 ROI（%）",
        fnw_roi_help: "平均預金金利（ポリシー既定値）を基準に設定されます。",
        fnw_label_e: "固定支出比率（%）",
        ...
        fnw_consent_label: "将来の純資産情報をサーバーに保存し、ソーシャルタブの貯蓄王ランキングに公開することに同意します。\n[収集項目] 目標期間・年収・名目賃金上昇率・資産/負債・インフレ率・ROI（割引率）・支出比率・一括支出計画・月積立能力 / [目的] 貯蓄王ランキング提供 / [保管] アカウント削除または初期化まで",
        ...
        fnw_detail_nwn_nominal: "予想純資産（名目）",
        fnw_detail_nwn_real: "予想純資産（現在価値換算）",
        fnw_detail_discount_factor: "割引係数",
        fnw_detail_nwn: "ROI反映前の純資産 (NW_n)",
        fnw_detail_roi: "年間投資収益率 (ROI)",
        fnw_detail_nw_real: "ROI反映後の純資産 (NW_n_nominal)",
        fnw_detail_msave: "月必要積立額 (M_save)",
        fnw_detail_mavail: "月積立能力 (M_avail)",
