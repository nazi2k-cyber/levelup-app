const i18n = {
    ...
    ja: {
        ...
        set_title: "システム設定", set_lang: "言語 (Language)", set_theme: "色", set_bg_theme_btn: "🎨 背景テーマ", bg_theme_modal_title: "背景テーマ", bg_theme_basic: "基本 (7種)", bg_theme_premium: "プレミアム", set_push: "プッシュ通知受信", set_gps: "起動時の位置情報取得", set_sync: "フィットネス同期 (Health Connect)", set_logout: "ログアウト", set_premium_expiry: "プレミアム有効期限", set_premium_manage_label: "プレミアムサブスク", set_premium_manage_btn: "Play Storeで管理",
