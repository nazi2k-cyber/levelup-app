const i18n = {
    ...
    en: {
        ...
        fnw_label_w0: "Annual Income (K KRW)",
        fnw_label_net_section: "Current Net Worth",
        fnw_label_assets: "Current Assets (K KRW)",
        fnw_label_liabilities: "Current Liabilities (K KRW)",
        fnw_label_net_auto: "Net Worth",
        fnw_label_r: "Annual Inflation Rate (%)",
        fnw_label_e: "Fixed Expense Ratio (%)",
        fnw_section_lump: "Lump-Sum Expenses (K KRW)",
        fnw_label_car: "Car",
    ...
    ja: {
        ...
        fnw_label_n: "目標期間（年）",
        fnw_label_w0: "現在の年収（万ウォン）",
        fnw_label_net_section: "現在の純資産",
        fnw_label_assets: "現在資産（万ウォン）",
        fnw_label_liabilities: "現在負債（万ウォン）",
        fnw_label_net_auto: "純資産",
        fnw_label_r: "年インフレ率（%）",
        fnw_label_e: "固定支出比率（%）",
        fnw_section_lump: "一括支出項目（万ウォン）",
        fnw_label_car: "自動車",
