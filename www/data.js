const i18n = {
    ko: {
        ...
        fnw_consent_label: "미래 순자산 정보를 서버에 저장하고 소셜탭 저축왕 순위에 공개하는 것에 동의합니다.\n[수집 항목] 목표 기간, 연소득, 명목 임금상승률, 현재 자산/부채, 물가상승률, 지출 비율, 목돈 지출 계획, 월 가용 저축력 / [수집 목적] 저축왕 순위 제공 / [보관] 계정 삭제 또는 초기화 시까지",
    ...
    en: {
        ...
        fnw_consent_label: "I agree to store my future net worth data on the server and publish it in the Savings King ranking on the Social tab.\n[Data collected] Goal period, annual income, nominal wage growth, assets/liabilities, inflation rate, expense ratio, lump-sum plans, monthly savings capacity / [Purpose] Savings King ranking / [Retention] Until account deletion or data reset",
    ...
    ja: {
        ...
        fnw_consent_label: "将来の純資産情報をサーバーに保存し、ソーシャルタブの貯蓄王ランキングに公開することに同意します。\n[収集項目] 目標期間・年収・名目賃金上昇率・資産/負債・インフレ率・支出比率・一括支出計画・月積立能力 / [目的] 貯蓄王ランキング提供 / [保管] アカウント削除または初期化まで",
