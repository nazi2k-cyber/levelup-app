const i18n = {
    ko: {
        ...
        excel_lib_loading: "Excel 라이브러리 로딩 중입니다. 잠시 후 다시 시도하세요.",
        excel_import_done: "플래너 데이터를 가져왔습니다. ({count}일)",
        excel_import_error: "Excel 파일을 읽을 수 없습니다. 형식을 확인하세요.",
    ...
    en: {
        ...
        excel_lib_loading: "Excel library loading. Please try again.",
        excel_import_done: "Planner data imported. ({count} days)",
        excel_import_error: "Could not read the Excel file. Check the format.",
    ...
    ja: {
        ...
        excel_lib_loading: "Excelライブラリ読み込み中です。",
        excel_import_done: "プランナーデータをインポートしました。({count}日)",
        excel_import_error: "Excelファイルを読み込めません。フォーマットを確認してください。",
