const i18n = {
    ko: {
        ...
        name_prompt: "새로운 닉네임을 입력하세요.", sync_req: "동기화 요청 중...", sync_done: "동기화 완료 (포인트 지급)", sync_off: "동기화 해제됨", sync_revoke_confirm: "건강 데이터 권한을 완전히 해제하려면 OS 설정에서 권한을 꺼야 합니다.\n앱 설정으로 이동하시겠습니까?", exit_hint: "종료하려면 다시 누르세요",
    ...
    en: {
        ...
        name_prompt: "Enter new player name.", sync_req: "Requesting sync...", sync_done: "Sync complete", sync_off: "Sync disabled", sync_revoke_confirm: "To fully revoke health data permission, you need to disable it in OS settings.\nGo to app settings?", exit_hint: "Press back again to exit",
    ...
    ja: {
        ...
        name_prompt: "新しいプレイヤー名を入力してください。", sync_req: "同期を要求中...", sync_done: "同期完了", sync_off: "同期解除", sync_revoke_confirm: "健康データの権限を完全に解除するには、OS設定で権限をオフにする必要があります。\nアプリ設定に移動しますか？", exit_hint: "もう一度押すと終了します",
