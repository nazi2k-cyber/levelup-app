const i18n = {
    ko: {
        ...
        step_title: "오늘의 걸음수", step_next_reward: "다음 보상까지 {n}보 남음", step_no_perm: "설정에서 피트니스 동기화를 활성화하세요",
        ...
        reels_report: "신고", reels_report_confirm: "이 게시물을 신고하시겠습니까?\n\n부적절한 콘텐츠, 스팸, 혐오 표현 등을 신고할 수 있습니다.",
        reels_report_reason_prompt: "신고 사유를 입력해주세요 (선택사항):",
    ...
    en: {
        ...
        step_title: "Today's Steps", step_next_reward: "{n} steps to next reward", step_no_perm: "Enable Fitness Sync in Settings",
        ...
        reels_report: "Report", reels_report_confirm: "Do you want to report this post?\n\nYou can report inappropriate content, spam, or hate speech.",
        reels_report_reason_prompt: "Please enter the reason for reporting (optional):",
    ...
    ja: {
        ...
        step_title: "今日の歩数", step_next_reward: "次の報酬まで{n}歩", step_no_perm: "設定でフィットネス同期を有効にしてください",
        ...
        reels_report: "通報", reels_report_confirm: "この投稿を通報しますか？\n\n不適切なコンテンツ、スパム、ヘイトスピーチなどを通報できます。",
        reels_report_reason_prompt: "通報理由を入力してください（任意）:",
