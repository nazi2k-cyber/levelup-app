const i18n = {
    ko: {
        ...
        perm_prompt_title: "권한 설정", perm_prompt_desc: "앱의 핵심 기능을 사용하려면\n아래 권한들을 허용해주세요.",
        perm_push_title: "푸시 알림", perm_push_desc: "레이드 알림, 일일 리마인더 등\n중요한 알림을 받을 수 있습니다.",
        perm_gps_title: "위치 정보", perm_gps_desc: "현위치 기반 던전 탐색 및\n로컬 레이드에 참여할 수 있습니다.",
        perm_fitness_title: "건강 데이터", perm_fitness_desc: "걸음 수를 연동하여\n보너스 포인트를 획득할 수 있습니다.",
        perm_btn_allow: "허용", perm_btn_skip: "나중에", perm_btn_done: "시작하기",
        perm_step: "단계",
    ...
    en: {
        ...
        perm_prompt_title: "Permissions", perm_prompt_desc: "Please allow the following permissions\nto use the app's core features.",
        perm_push_title: "Push Notifications", perm_push_desc: "Receive raid alerts, daily reminders,\nand important notifications.",
        perm_gps_title: "Location", perm_gps_desc: "Explore nearby dungeons and\njoin local raids.",
        perm_fitness_title: "Health Data", perm_fitness_desc: "Sync your step count\nto earn bonus points.",
        perm_btn_allow: "Allow", perm_btn_skip: "Later", perm_btn_done: "Get Started",
        perm_step: "Step",
    ...
    ja: {
        ...
        perm_prompt_title: "権限設定", perm_prompt_desc: "アプリの主要機能を利用するために\n以下の権限を許可してください。",
        perm_push_title: "プッシュ通知", perm_push_desc: "レイド通知やデイリーリマインダーなど\n重要な通知を受け取れます。",
        perm_gps_title: "位置情報", perm_gps_desc: "現在地周辺のダンジョン探索や\nローカルレイドに参加できます。",
        perm_fitness_title: "健康データ", perm_fitness_desc: "歩数を連携して\nボーナスポイントを獲得できます。",
        perm_btn_allow: "許可", perm_btn_skip: "後で", perm_btn_done: "始める",
        perm_step: "ステップ",
