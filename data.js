const i18n = {
    ko: {
        ...
        diary_save: "저장", diary_saved: "플래너가 저장되었습니다.", diary_written: "작성 완료 ✓", planner_no_timetable: "시간표를 최소 1개 이상 입력해주세요.",
    ...
    en: {
        ...
        diary_save: "Save", diary_saved: "Planner saved.", diary_written: "Written ✓", planner_no_timetable: "Please add at least one timetable entry.",
    ...
    ja: {
        ...
        diary_save: "保存", diary_saved: "プランナーが保存されました。", diary_written: "記録完了 ✓", planner_no_timetable: "タイムテーブルを1つ以上入力してください。",
