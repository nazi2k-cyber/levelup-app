const i18n = {
    ko: {
        ...
        cam_guide: "ISBN 바코드 스캔을 위해 카메라 권한이 필요합니다.\n내 서재에서 책을 스캔할 때 사용됩니다.",
    ...
    en: {
        ...
        cam_guide: "Camera permission is required for ISBN barcode scanning.\nUsed when scanning books in My Library.",
    ...
    ja: {
        ...
        cam_guide: "ISBNバーコードスキャンにカメラ権限が必要です。\n私の書斎で本をスキャンする際に使用されます。",
